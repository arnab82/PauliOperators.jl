...
"""
function compile(A::RankMap{N}, generators::Vector{PauliBasis{N,W}}, angles::Vector{<:Real};
                 window::Int=1, version::Int=0) where {N,W}
    ...
    return CompiledCircuit{N,W}(generators, Float64.(angles), shifts, window, subgroups, version)
end

compile(B::BinnedPauliSum{N}, generators::Vector{PauliBasis{N,W}}, angles::Vector{<:Real};
        window::Int=1) where {N,W} =
